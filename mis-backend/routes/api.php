...
use App\Http\Controllers\Api\EmployeeSalaryHistoryController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/qr-access/{token}', [QrAccessController::class, 'show']);
    Route::get('/customer-portal/apartments', [CustomerPortalController::class, 'index']);
    ...
    Route::middleware('internal.user.only')->group(function () {
        ...
        Route::get('/employee-salary-histories', [EmployeeSalaryHistoryController::class, 'index']);
        ...
        Route::put('/accounts/{uuid}', [AccountController::class, 'update']);
        Route::delete('/accounts/{uuid}', [AccountController::class, 'destroy']);
        Route::delete('/accounts/{uuid}/force', [AccountController::class, 'forceDestroy']);
        Route::get('/account-transactions', [AccountTransactionController::class, 'index']);
        Route::get('/exchange-rates', [ExchangeRateController::class, 'index']);
        Route::post('/exchange-rates', [ExchangeRateController::class, 'store']);
        Route::put('/exchange-rates/{uuid}', [ExchangeRateController::class, 'update']);
        Route::delete('/exchange-rates/{uuid}', [ExchangeRateController::class, 'destroy']);
        Route::delete('/exchange-rates/{uuid}/force', [ExchangeRateController::class, 'forceDestroy']);
        ...
        Route::post('/apartment-sales/{uuid}/approve', [ApartmentSaleController::class, 'approve']);
        Route::post('/apartment-sales/{uuid}/reject', [ApartmentSaleController::class, 'reject']);
        ...
        Route::put('/document-types/{uuid}', [DocumentTypeController::class, 'update']);
        Route::delete('/document-types/{uuid}', [DocumentTypeController::class, 'destroy']);
