...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (!Schema::hasColumn('apartment_sales', 'actual_net_revenue')) {
            Schema::table('apartment_sales', function (Blueprint $table): void {
                $table->decimal('actual_net_revenue', 15, 2)->default(0)->after('net_price');
            });
        }
        ...
        DB::table('apartment_sales')
            ...
            ->chunkById(500, function ($sales) use ($paidTotals, $financials, $terminations): void {
                foreach ($sales as $sale) {
                    ...
                    $municipalityShare15 = round((float) ($financial->municipality_share_15 ?? 0), 2);
    ...
    public function down(): void
    {
        ...
        Schema::table('apartment_sales', function (Blueprint $table): void {
            $table->dropColumn('actual_net_revenue');
        });
    }
};
