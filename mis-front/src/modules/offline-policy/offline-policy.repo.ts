...
export const DEFAULT_OFFLINE_POLICY: OfflinePolicy = {
  ...
  module_retention_days: {
    ...
    employees: DEFAULT_RETENTION_DAYS,
      ...
      vendors: DEFAULT_RETENTION_DAYS,
      warehouses: DEFAULT_RETENTION_DAYS,
      materials: DEFAULT_RETENTION_DAYS,
      company_assets: DEFAULT_RETENTION_DAYS,
      projects: DEFAULT_RETENTION_DAYS,
      material_requests: DEFAULT_RETENTION_DAYS,
      purchase_requests: DEFAULT_RETENTION_DAYS,
      asset_requests: DEFAULT_RETENTION_DAYS,
      stock_movements: DEFAULT_RETENTION_DAYS,
      warehouse_material_stocks: DEFAULT_RETENTION_DAYS,
      project_material_stocks: DEFAULT_RETENTION_DAYS,
...
export function normalizeOfflinePolicy(input: unknown): OfflinePolicy {
  ...
  return {
    ...
    module_retention_days: {
      ...
      vendors: toDays(moduleRetention.vendors),
      warehouses: toDays(moduleRetention.warehouses),
      materials: toDays(moduleRetention.materials),
      company_assets: toDays(moduleRetention.company_assets),
      projects: toDays(moduleRetention.projects),
      material_requests: toDays(moduleRetention.material_requests),
      purchase_requests: toDays(moduleRetention.purchase_requests),
      asset_requests: toDays(moduleRetention.asset_requests),
      stock_movements: toDays(moduleRetention.stock_movements),
      warehouse_material_stocks: toDays(moduleRetention.warehouse_material_stocks),
      project_material_stocks: toDays(moduleRetention.project_material_stocks),
...
export const OFFLINE_POLICY_MODULE_LABELS: Record<OfflineModuleKey, string> = {
  ...
  warehouse_material_stocks: "Warehouse Material Stocks",
  project_material_stocks: "Project Material Stocks",
  roles: "Roles",
  users: "Users",
  rentals: "Rentals",
