...
const MODULE_CONFIG: Record<OfflineModuleKey, ModuleCleanupConfig> = {
  ...
  purchase_requests: { getTable: () => db.purchase_requests, entity: "purchase_requests" },
  ...
  warehouse_material_stocks: { getTable: () => db.warehouse_material_stocks, entity: "warehouse_material_stocks" },
  project_material_stocks: { getTable: () => db.project_material_stocks, entity: "project_material_stocks" },
...
const ROLLBACK_ENTITY_TABLES: Record<string, (() => RollbackTable | undefined) | undefined> = {
  ...
  purchase_requests: () => db.purchase_requests as unknown as RollbackTable,
